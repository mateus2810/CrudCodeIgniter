...
<!-- Morris.js charts -->
<script src="<?= base_url() ?>assets/theme/bower_components/raphael/raphael.min.js"></script>
...
<!-- jQuery Knob Chart -->
<script src="<?= base_url() ?>assets/theme/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?= base_url() ?>assets/theme/bower_components/moment/min/moment.min.js"></script>
<script src="<?= base_url() ?>assets/theme/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?= base_url() ?>assets/theme/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="<?= base_url() ?>assets/theme/dist/js/pages/dashboard.js"></script>
